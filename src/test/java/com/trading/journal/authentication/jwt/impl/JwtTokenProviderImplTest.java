...
// @BeforeEach
// public void setUp() {
// tokenProvider = new JwtTokenProviderImpl(null);
// }

// @Test
// @DisplayName("Given user and its roles when generateJwtToken, return JWT
// token")
...
// tokenProvider.getAccessTokenInfo(tokenData.token());
// assertThat(accessTokenInfo.roles()).containsOnly(AuthoritiesHelper.ROLE_ADMIN,
// AuthoritiesHelper.ROLE_USER);
// }

// @Test
// @DisplayName("Given user with null roles when generateJwtToken, return
// exception")
// void nullRoles() {
// ApplicationUser appUser = new ApplicationUser(
// "UserAdm",
...
// @Test
// @DisplayName("Given user with empty roles when generateJwtToken, return
// exception")
// void emptyRoles() {
// ApplicationUser appUser = new ApplicationUser(
// "UserAdm",
...
// .claim(JwtHelper.AUTHORITIES,
// Collections.singletonList(AuthoritiesHelper.ROLE_USER))
// .compact();
...
// @Test
// @DisplayName("Given almost expired jwt token when validateToken return
// valid")
...
// tokenProvider.getAuthentication(tokenData.token());

// assertThat(((User)
// authentication.getPrincipal()).getUsername()).isEqualTo("UserAdm");
// assertThat(authentication.getAuthorities().toArray()).contains(new
